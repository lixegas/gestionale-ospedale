...
def visualizza():
    ...
    user_visualizzato = visualizza_paziente(codice_fiscale)
    
    if password == user_visualizzato["password"]:
            print(user_visualizzato)
    else:
            print("Password errata") 
...
def aggiorna_paziente():
    ...
    if DOMANDA_CONFERMA == "si":
        ...
        LISTA_DATI = ("nome paziente" , "indirizzo", "numero di telefono", "email", "password")
        print(LISTA_DATI)
        ...
        if DATI_DA_MODIFICARE == LISTA_DATI[1]:
        ...
        if DATI_DA_MODIFICARE == LISTA_DATI[2]:
        ...
        if DATI_DA_MODIFICARE == LISTA_DATI[3]:
        ...
        if DATI_DA_MODIFICARE == LISTA_DATI[4]:
